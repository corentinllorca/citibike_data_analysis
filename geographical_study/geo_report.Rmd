...
most_started <- plyr::count(concise_trips_merged, c("start_station_id"))
```
...
most_started_merged <- most_started_merged[order(-most_started_merged$freq),]

#COMPUTING THE MOST ENDED STATIONS
colnames(stations_info)[1] = 'end_station_id'
most_ended <- plyr::count(concise_trips_merged, c(end_station_id))
