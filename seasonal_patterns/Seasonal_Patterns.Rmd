...
*Fig 1. The average daily number of trips from October 2014 to September 2018*
...
*Fig 2. The difference in relative frequency of trips across February, July and October between customers and subscribers*
...
map_summer <- map_summer %>%
  ...
  addLegend("bottomright", 
            ...
            labels = c("Subscribers", "Customers"),
            title = "Types of users")
  
sync(map_winter, map_summer)
```

*Fig 3. The most popular stations by type of users in Winter (left) and Summer (right). Green markers represent the customer group (tourists) and blue markers represent annual members}*
