...
In this section, we will cover our exploratory data analysis process on the Citi Bike data, and the results obtained. For the whole of this section, we have generated our own csv file, as a result of a preprocessing step and a data cleaning step. Here
